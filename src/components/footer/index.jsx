...
const Footer = () => {
  ...
  return (
    <footer className={cn("pt-8 px-4")}>
      <div
        className={cn(
          "container border-t mx-auto py-8 flex flex-col gap-4",
          isLightTheme
            ? "border-[#932D6F]/20 text-slate-800"
            : "border-[#932D6F]/50 text-slate-200"
        )}
      >
        ...
        <div
          className={cn(
            "flex gap-4 md:gap-8 flex-col md:flex-row md:items-center",
