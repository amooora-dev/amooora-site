...
const Content = ({
  ...
  return (
    <section id={id} className='py-10 px-3 md:px-0'>
      <div
        className={cn(
          "container flex items-center justify-between gap-8 md:flex-row mx-auto relative",
          isImgLeft ? "flex-col" : "flex-col-reverse"
        )}
      >
        {isImgLeft ? (
        ...
        <div className='grow flex flex-col max-w-[750px] z-10'>
          ...
          <h2
            className={cn(
              "text-[2.3rem] font-bold tracking-[-0.5px] mb-3 title"
            )}
          >
            {title}
          </h2>
